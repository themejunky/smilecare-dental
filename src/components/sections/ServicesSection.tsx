...
const services = [
  {
    ...
    icon: <FaTooth className="text-4xl text-blue-500 mb-4" />,
  },
  {
    id: 2,
    ...
    icon: <FaSmile className="text-4xl text-blue-500 mb-4" />,
  },
  {
    id: 3,
    ...
    icon: <FaChild className="text-4xl text-blue-500 mb-4" />,
  },
  {
    id: 4,
    title: 'Orthodontics',
    ...
    icon: <FaTeeth className="text-4xl text-blue-500 mb-4" />,
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service) => (
            <div 
              key={service.id} 
              className="bg-blue-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center text-center"
            >
              {service.icon}
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-2xl font-bold text-blue-900 mb-4">Why Choose SmileCare Dental?</h3>
